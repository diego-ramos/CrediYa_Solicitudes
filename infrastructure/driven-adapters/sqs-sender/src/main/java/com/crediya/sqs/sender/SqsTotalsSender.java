...
public class SqsTotalsSender implements SqsMessagePublisher<SqsTotalsMessage> {
    private final SQSSenderProperties properties;
    private final SqsAsyncClient client;
    private final ObjectMapper objectMapper;

    @Override
    public Mono<String> send(SqsTotalsMessage sqsMessage) {
    ...
    private SendMessageRequest buildRequest(SqsTotalsMessage message) throws JsonProcessingException {
        return SendMessageRequest.builder()
                .queueUrl(properties.totalsQueueUrl())
